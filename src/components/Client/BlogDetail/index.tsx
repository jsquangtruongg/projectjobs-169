...
export const BlogDetailComponent = () => {
  return (
    <div className={styles.from_heading}>
      <div>
        <div>
          <p className={styles.heading_title}>
          ...
          <div className={styles.from_information}>
            ...
            <p className={styles.text_date}>09/09/2024</p>
          </div>
          <div className={styles.form_img_heading}>
            <img src={imgPost} alt="" className={styles.img_heading} />
          </div>
          <div className={styles.from_content_blog}>
            ...
            <div className={styles.from_blog_main}>
              <div className={styles.form_item_blog}>
                ...
                <p className={styles.text_blog_hot}>
                  Những công nghệ hot nhất hiện nay trong lĩnh vực IT lương lên
                  đến 10.000$
                </p>
